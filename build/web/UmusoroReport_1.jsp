...
<html>   
    ...
    <body style="background: #fed200">
        <%
            ...
            Paragraph par = new Paragraph(new Chunk("MONTHLY REPORT OF UMUSORO", font2));
            ...
            try {
                ...
                String sql = "select *from Umusanzu where MONTH(deposit_Date)=MONTH(NOW()) and YEAR(deposit_Date)=YEAR(NOW()) ORDER BY deposit_Date DESC ";
